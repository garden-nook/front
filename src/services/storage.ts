  ...
  if (plots.length === 0) {
    ...
    const demoBeds: Bed[] = [
      ...
      },
      {
        ...
        width: 45,
        height: 20,
        cropHistory: [{ name: "Томаты", date: "15.05.2025" }],
        lightLevel: "полутень",
      },
      {
        id: "3",
      ...
      },
      {
        ...
        width: 40,
        height: 45,
        cropHistory: [{ name: "Огурцы", date: "20.05.2025" }],
        lightLevel: "полутень",
      },
    ];
    saveBeds("1", demoBeds);
