  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.fields}>
        ...
        <div style={styles.info}>
          ...
          <ul style={styles.list}>
            <li>
              <strong>Регистрация:</strong> <code>response.data.data.user_id</code>
            </li>
            <li>
              <strong>Вход:</strong> <code>response.data.data.access_token</code>
            </li>
            <li>
              <strong>Профиль:</strong> <code>response.data.data.id</code>
            </li>
          </ul>
      ...
      <div style={styles.buttons}>
        ...
        <button
          onClick={() => withLoading(getProfile)}
          disabled={loading}
      ...
      {result && (
        <div
          style={{
            ...styles.result,
            ...(result.type === "success" ? styles.success : styles.fail),
          }}
        >
          <div style={styles.resultMessage}>{result.message}</div>
          {result.data && <pre style={styles.json}>{JSON.stringify(result.data, null, 2)}</pre>}
        </div>
      )}

      <div
        style={{ ...styles.tokenStatus, ...(hasToken ? styles.tokenExists : styles.tokenMissing) }}
      >
      ...
      <div style={styles.instructions}>
        ...
        <ol style={styles.instructionsList}>
          ...
          <li>
            Нажмите <strong>"Регистрация"</strong> — создаст нового пользователя
          </li>
          <li>
            Нажмите <strong>"Вход"</strong> — войдет и сохранит токен
          </li>
          <li>
            Нажмите <strong>"Профиль"</strong> — получит данные профиля
          </li>
          <li>
            Нажмите <strong>"Выход"</strong> — удалит токен
          </li>
        </ol>
